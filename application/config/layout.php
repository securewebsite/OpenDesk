...
| -------------------------------------------------------------------
*/
$config['app_title']       		="OpenDesk";
$config['app_keywords']     	= "";
$config['app_description']  	= "";
$config['app_basepath'] 		= "/var/www/projects/opendesk/";
$config['app_absolutepath'] 	= "/var/www/projects/opendesk/assets/default/";
$config['app_copyright']  		= "(c) 2013 Etude Software Services (Pty) Ltd. All Rights Reserved.";
$config['app_version']     		= "Version 2.0.0";
$config['app_releasedate'] 		= "01 December 2015";
?>